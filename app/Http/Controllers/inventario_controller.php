...
class inventario_controller extends Controller
{
    ...
    {
        try {
            $iventarios = inventario::with([
                'control' => function ($query) {
    ...
    {
        try {
            $iventario = inventario::with('consultorio')
                ->with([
                    'control' => function ($query) {
    ...
    {
        try {
            $iventario = control_inventario::where('Inx_Id', $req->all()['inx_id'])->get();
    ...
    {
        try {
            $inventario = control_inventario::where('Cinx_id', $req->all()['Cinx_id'])->delete();
